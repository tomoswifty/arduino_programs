...
const int ch2 = 10; //12; // left vertical
const int ch4 = 12; //10
//10; // left horizontal
...
#define soc1 24 //pcb 4 DO4
#define soc2 22 //pcb 3 DO5
...
void AttachmentModeChange() {
  directionMode = pulseIn(ch5, HIGH);
  if (directionMode >1550) {
      gMode = 1;
...
void batteryData(){
      ...
      Serial.print(","); Serial.print(directionMode); 
